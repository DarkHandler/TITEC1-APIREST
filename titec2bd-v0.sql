...
CREATE TABLE `actividades` (
  `codigo_actividad` int(11) NOT NULL AUTO_INCREMENT,
...
/*!50001 CREATE TABLE `all_talleres` (
  `codigo_actividad` tinyint NOT NULL,
  `rut_responsable` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `cupos` tinyint NOT NULL,
  `direccion` tinyint NOT NULL,
  `nombre_actividad` tinyint NOT NULL,
  `estado_actividad` tinyint NOT NULL,
  `descripción` tinyint NOT NULL,
  `fecha_inicio` tinyint NOT NULL,
  `fecha_termino` tinyint NOT NULL,
  `modalidad` tinyint NOT NULL,
  `requisitos` tinyint NOT NULL,
...
INSERT INTO `correo` VALUES ('13.231.412-2','eugenio.alonso@gmail.com'),('14.222.313-3','sebastian.rodrigo@gmail.com'),('17.333.222-2','mauricio.gonzalo2@gmail.com'),('17.333.222-2','mauricio.gonzalo@gmail.com');
/*!40000 ALTER TABLE `correo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `datos_profesor`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `datos_profesor` (
  `rut` tinyint NOT NULL,
  `nombres` tinyint NOT NULL,
  `apellidos` tinyint NOT NULL,
  `numero_contacto` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Dumping routines for database 'titec2bd'
--
/*!50003 DROP FUNCTION IF EXISTS `validate_rut` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50001 DROP TABLE IF EXISTS `all_talleres`*/;
/*!50001 DROP VIEW IF EXISTS `all_talleres`*/;
...
/*!50001 DROP TABLE IF EXISTS `datos_profesor`*/;
/*!50001 DROP VIEW IF EXISTS `datos_profesor`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
-- Dump completed on 2022-08-10 10:51:08
