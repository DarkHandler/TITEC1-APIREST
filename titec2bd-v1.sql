...
--
-- Host: localhost    Database: titec2bd
-- ------------------------------------------------------
...
INSERT INTO `actividades` VALUES (1,'13.231.412-2','Taller',30,'Av. Cubo Rubik 123','Futbol','Postulando','Esta actividad se realiza con todos los clubes deportivos de quintero','2022-01-01','2022-02-02','Presencial','Tener entusiasmo y zapatillas de football','Futbol',-1),(2,'14.222.313-3','Taller',30,'Av. Diputado Vivar 312','Basquetbol','Postulando','Esta actividad se realiza con todos los clubes deportivos de quintero que son de basquetbol','2022-01-01','2022-02-02','Presencial','Tener entusiasmo y balon de basquetbol','Basquetbol',-1),(3,'17.333.222-2','Taller',40,'Av. Argleton Bar´s','Natacion','Postulando','Este taller se realiza en el unico lugar deportivo de chile','2022-03-03','2022-04-04','Presencial','Tener gorra de baño, mascarilla y sufles','Natacion',-1),(4,'13.231.412-2','Taller',30,'Manuel acevedo 312','Beisbolito','Postulando','Este es el taller de beisbol para menores entre 12 a 15 anios','2022-05-20','2022-06-20','Presencial','Comprarse gorra de beisbol, un bate y tener motivacion','Beisbol',-1),(5,'13.231.412-2','Taller',30,'Pruebas','Pruebas2','Postulando','Esta es la prueba del taller','2022-06-20','2022-07-20','Presencial','Pruebas3','Pruebas4',-1),(6,'13.231.412-2','Taller',30,'Pruebas5','Pruebas6','Postulando','Esta es la prueba del taller 2','2022-07-20','2022-08-20','Presencial','Pruebas7','Pruebas8',-1);
...
INSERT INTO `correo` VALUES ('13.231.412-2','eugenio.alonso@gmail.com'),('14.222.313-3','sebastian.rodrigo@gmail.com'),('17.333.222-2','mauricio.gonzalo@gmail.com'),('17.333.222-2','mauricio.gonzalo2@gmail.com'),('19.791.147-6','ian.quiero@alumnos.uv.cl'),('20.271.137-5','Jdjd@gmail.com');
...
INSERT INTO `direccion` VALUES ('19.791.147-6','Distrito mayor Urbano',28,'Loncura','Calle falsa #321'),('20.271.137-5','Distrito mayor Urbano',6464,'Hwhshs','Hshshs');
...
INSERT INTO `direccion_multimedia` VALUES (1,'futlbol.jpg'),(2,'basquetbol.jpg'),(1,'futbol2.jpg'),(3,'natacion.jpg');
...
INSERT INTO `persona` VALUES ('13.231.412-2','Eugenio Alonso','Vivar Cortes','+569312412','1999-01-01','FONASA',NULL),('14.222.313-3','Sebastian Rodrigo','Yañez Medina','+5691112233','1999-02-03','ISAPRE',NULL),('17.333.222-2','Mauricio Gonzalo','Olivares Soto','+5694242312','1972-03-07','ISAPRE',NULL),('19.791.147-6','Ian Alonso','Quiero Cardenas','+56985413789','1998-08-04','Fonasa',NULL),('20.271.137-5','Jsjs','Sjsjs','+5692948','2014-08-21','Fonasa',NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `check_rut` BEFORE INSERT ON `persona` FOR EACH ROW begin
...
CREATE TABLE `solicitud_deportiva` (
  ...
  `datos_extra` text,
  `obs_medica` text,
  `estado` enum('aceptada','pendiente','rechazada','en lista de espera') DEFAULT 'pendiente',
...
INSERT INTO `solicitud_deportiva` VALUES (6,'19.791.147-6',1,'2022-09-01',NULL,NULL,'pendiente'),(11,'20.271.137-5',1,'2022-09-03',NULL,NULL,'pendiente');
...
-- Dump completed on 2022-09-04 20:24:47
